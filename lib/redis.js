  ...
  if (isClient(settings)) {
    ...
    try {
      if (typeof settings === 'object') {
        settings = Object.assign({enableReadyCheck: true}, settings);
      }
...
function isClient(object) {
  ...
  return ['Redis', 'RedisClient', 'EventEmitter', 'Commander'].indexOf(name) >= 0 && typeof object.disconnect === 'function' && typeof object.connect === 'function';
}
